{
  ...
  TFile* f = new TFile("Results/Groom_AuAu.root","READ");
  // TFile* f = new TFile("Results/Groom_SmallAuAu.root","READ");
  // TFile* f = new TFile("Results/HighConsGroom_SmallAuAu.root","READ");
  ...
  // =========================== Draw spectra ===============================
  new TCanvas;
  leg = new TLegend( 0.55, 0.75, 0.89, 0.9, "AuAu HT" );
  leg->SetBorderSize(0);
  leg->SetLineWidth(10);
  leg->SetFillStyle(0);
  leg->SetMargin(0.1);
  ...
  leg->Draw("same");
  gPad->SaveAs("Plots/AuAuGroomSpectra.png");

  // =========================== Draw original ===============================
  new TCanvas;
  gPad->SetGridx(0);  gPad->SetGridy(0);
  TLegend* leg = new TLegend( 0.6, 0.65, 0.89, 0.9, "AuAu HT, Leading jet" );
  leg->SetBorderSize(0);
  leg->SetLineWidth(10);
  leg->SetFillStyle(0);
  leg->SetMargin(0.1);
